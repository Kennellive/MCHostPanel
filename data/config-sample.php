...
define('KT_SCREEN_CMD_START','/opt/app-root/miniconda3/bin/tmux new -d -s %s /opt/app-root/miniconda3/bin/java -Xincgc -Xms%sM -Xmx%sM -jar craftbukkit.jar');
define('KT_SCREEN_CMD_EXEC','/opt/app-root/miniconda3/bin/tmux send -t %s "%s" ENTER');
